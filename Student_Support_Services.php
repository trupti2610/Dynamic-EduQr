      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h2 style="margin-top: 100px;">Student Support Services </h2>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="well-left">
            ...
            <div class="single-well" style="width: 35%;">
              <a href="Student_Support_Services_Feedback_form.php">
                <img src="img/QR-Code/Student_upport_Services.png" alt="" style="margin-left: 340px;
              ">
              </a>
            </div>
          </div>
